...
{!loading && repository && repositoryInsights && (
  <Card
    padding="lg"
    className="rounded-2xl"
  >
    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      ...
      <Badge
        variant={
          repositoryInsights.activity === "active"
            ? "success"
            : repositoryInsights.activity === "recent"
              ? "info"
              : repositoryInsights.activity === "stale"
                ? "warning"
                : undefined
        }
      >
    ...
    <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="rounded-xl border border-gray-200 bg-gray-50 p-5 dark:border-gray-800 dark:bg-gray-800/50">
        ...
        <p className="mt-2 text-lg font-bold text-gray-900 dark:text-white">
          {repositoryInsights.repositoryStatus.label}
        </p>

        <p className="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
          {repositoryInsights.repositoryStatus.description}
        </p>
      </div>
    ...
    <div className="mt-6 border-t border-gray-200 pt-6 dark:border-gray-800">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <Badge
          variant={
            repositoryInsights.hasPullRequests
              ? "success"
              : undefined
          }
        >
        ...
        <Badge
          variant={
            repositoryInsights.hasDiscussions
              ? "info"
              : undefined
          }
        >
        ...
        {repositoryInsights.isTemplate && (
          <Badge variant="info">
            GitHub template
          </Badge>
        )}

        {repositoryInsights.isFork && (
          <Badge variant="info">
            Fork
          </Badge>
        )}

        {repositoryInsights.isArchived && (
    ...
    <div className="mt-6 rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Based on stars, forks, issues, discussions,
            and pull requests.
          </p>
        </div>

        <div className="text-sm font-semibold text-gray-900 dark:text-white">
          {repositoryInsights.communityScore}/7 signals
        </div>
      </div>
      ...
      <div className="mt-4 h-2 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800">
        <div
          ...
          style={{
            width: `${Math.round(
              (repositoryInsights.communityScore / 7) *
                100
            )}%`,
          }}
        />
      ...
      <p className="mt-3 text-xs leading-5 text-gray-500 dark:text-gray-400">
        This is a simple activity/community indicator,
        not a rating of project quality, security, or
        maintainability.
      </p>
    </div>
  </Card>
